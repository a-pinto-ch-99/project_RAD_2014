...
class EquipmentControllerTest < ActionController::TestCase
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post :create, equipment: { eq_description: @equipment.eq_description, eq_name: @equipment.eq_name, eq_number: @equipment.eq_number }
    end
  ...
  test "should update equipment" do
    patch :update, id: @equipment, equipment: { eq_description: @equipment.eq_description, eq_name: @equipment.eq_name, eq_number: @equipment.eq_number }
    assert_redirected_to equipment_path(assigns(:equipment))
  end
